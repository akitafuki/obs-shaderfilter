...
static const struct shader_category_entry shader_category_table[] = {
    ...
    {"emboss_color", "retro"},
    {"gameboy", "retro"},
    {"gameboy_screen", "retro"},
    {"gb-camera", "retro"},
    {"glitch-periodic", "retro"},
    {"glitch", "retro"},
    {"glitch_analog", "retro"},
    {"hacker_overdrive", "retro"},
    {"halftone", "retro"},
    {"low_health_throb", "retro"},
    {"matrix", "retro"},
    {"pixelation", "retro"},
    {"scan_line", "retro"},
    {"thermal", "retro"},
    ...
    {"event_horizon", "distort"},
    {"Swirl", "distort"},
    {"wide_stretch", "distort"},
    {"ZigZag", "distort"},
    {"corner-pin", "distort"},
    {"corner_pin", "distort"},
    {"curve", "distort"},
    ...
    {"frost_overtake", "generative"},
    {"glass", "generative"},
    {"god_rays_ascend", "generative"},
    ...
    {"tetra", "generative"},
    {"underwater_caustics", "generative"},
