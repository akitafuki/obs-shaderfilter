...
static void convert_mat_mul(struct dstr *effect_text, char *var_type) {
  ...
  while (pos) {
    ...
    if (*begin == '(') {
      ...
      ch = begin + 1;
      while (*ch != 0) {
        while (*ch != ';' && *ch != '(' && *ch != ')' && *ch != '+' && *ch != '-' && *ch != '/' && *ch != '*' && *ch != 0)
          ch++;
        if (*ch == '(') {
          ch++;
          depth++;
      ...
      if (*ch == '(') {
        ...
        if (*ch == '.') {
          ...
          ch--;
                   ...
                   (strncmp(begin, "length(", 7) == 0 || strncmp(begin, "float(", 6) == 0 || strncmp(begin, "uint(", 5) == 0 ||
                    strncmp(begin, "int(", 4) == 0 || strncmp(begin, "asfloat(", 8) == 0 || strncmp(begin, "asdouble(", 9) == 0 ||
          ...
          depth++;
                   ...
                   (strncmp(begin, "abs(", 4) == 0 || strncmp(begin, "acos(", 5) == 0 || strncmp(begin, "asin(", 5) == 0 ||
                    strncmp(begin, "atan(", 5) == 0 || strncmp(begin, "atan2(", 6) == 0 || strncmp(begin, "ceil(", 5) == 0 ||
                    strncmp(begin, "clamp(", 6) == 0 || strncmp(begin, "cos(", 4) == 0 || strncmp(begin, "cosh(", 5) == 0 ||
                    strncmp(begin, "ddx(", 4) == 0 || strncmp(begin, "ddy(", 4) == 0 || strncmp(begin, "degrees(", 8) == 0 ||
                    strncmp(begin, "exp(", 4) == 0 || strncmp(begin, "exp2(", 5) == 0 || strncmp(begin, "floor(", 6) == 0 ||
                    strncmp(begin, "fma(", 4) == 0 || strncmp(begin, "fmod(", 5) == 0 || strncmp(begin, "frac(", 5) == 0 ||
                    strncmp(begin, "frexp(", 6) == 0 || strncmp(begin, "fwidth(", 7) == 0 || strncmp(begin, "ldexp(", 6) == 0 ||
                    strncmp(begin, "lerp(", 5) == 0 || strncmp(begin, "log(", 4) == 0 || strncmp(begin, "log10(", 6) == 0 ||
                    strncmp(begin, "log2(", 5) == 0 || strncmp(begin, "mad(", 4) == 0 || strncmp(begin, "max(", 4) == 0 ||
                    strncmp(begin, "min(", 4) == 0 || strncmp(begin, "modf(", 5) == 0 || strncmp(begin, "mod(", 4) == 0 ||
                    strncmp(begin, "mul(", 4) == 0 || strncmp(begin, "normalize(", 10) == 0 || strncmp(begin, "pow(", 4) == 0 ||
                    strncmp(begin, "radians(", 8) == 0 || strncmp(begin, "rcp(", 4) == 0 || strncmp(begin, "reflect(", 8) == 0 ||
                    strncmp(begin, "refract(", 8) == 0 || strncmp(begin, "round(", 6) == 0 || strncmp(begin, "rsqrt(", 6) == 0 ||
                    strncmp(begin, "saturate(", 9) == 0 || strncmp(begin, "sign(", 5) == 0 || strncmp(begin, "sin(", 4) == 0 ||
                    strncmp(begin, "sincos(", 7) == 0 || strncmp(begin, "sinh(", 5) == 0 ||
                    strncmp(begin, "smoothstep(", 11) == 0 || strncmp(begin, "sqrt(", 5) == 0 || strncmp(begin, "step(", 5) == 0 ||
                    strncmp(begin, "tan(", 4) == 0 || strncmp(begin, "tanh(", 5) == 0 || strncmp(begin, "transpose(", 10) == 0 ||
